...
//Deprecated
	if ($('filter_hack_id') != null)
	    $('filter_hack_id').value='';
	if ($('filter_type') != null)
	    $('filter_type').value='';
...
<fieldset id="filters" class="filters">
	...
	<div style="float:right;">
		<div style="float:left">
			<!-- SEARCH : filter_search : search on Name + Description  -->
	...
	<div>
		<div style="float:left">
			<!-- SELECT : Hack > Name  -->
				...
				<div class='filter filter_hack_id'>
		
					<?php echo JDom::_('html.form.input.select', array(
											'dataKey' => 'filter_hack_id',
											'dataValue' => $this->filters['hack_id']->value,
											'list' => $this->filters['hack_id']->list,
											'labelKey' => 'name',
											'nullLabel' => "JHACKS_FILTER_NULL_HACK_NAME",
		...
		<div style="float:left">
			<!-- SELECT : Regex  -->
					...
					<div class='filter filter_regex'>
			
						<?php
						$choices = array();
						$choices[] = array("value" => null, 'text'=>JText::_( "JHACKS_FILTER_NULL_REGEX" ));
						$choices[] = array("value" => '0', 'text'=>JText::_( "JNO" ));
						$choices[] = array("value" => '1', 'text'=>JText::_( "JYES" ));

						echo JDom::_('html.form.input.select', array(
											'dataKey' => 'filter_regex',
											'dataValue' => $this->filters['regex']->value,
											'list' => $choices,
											'listKey' => 'value',
											'labelKey' => 'text',
											'submitEventName' => 'onchange'
		...
		<div style="float:left">
			<!-- SELECT : Publish  -->
					...
					<div class='filter filter_publish'>
						...
						<?php
						$choices = array();
						$choices[] = array("value" => null, 'text'=>JText::_( "JHACKS_FILTER_NULL_PUBLISH" ));
						$choices[] = array("value" => '0', 'text'=>JText::_( "JNO" ));
						$choices[] = array("value" => '1', 'text'=>JText::_( "JYES" ));
